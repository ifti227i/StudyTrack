...
* The original package name 'com.example.studytrack.studytrack-backend' is invalid and this project uses 'com.example.studytrack.studytrack_backend' instead.
